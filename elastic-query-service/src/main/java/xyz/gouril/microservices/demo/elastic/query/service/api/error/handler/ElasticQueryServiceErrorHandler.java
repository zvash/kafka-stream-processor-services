package xyz.gouril.microservices.demo.elastic.query.service.api.error.handler;
...
public class ElasticQueryServiceErrorHandler {
    ...
    public ResponseEntity<String> handle(Exception e) {
        LOG.error("Service internal exception!", e);
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body("Service internal exception! " + e.getMessage());
    }
